...
from testcase.api.measure.report.get_measure_report import GetMeasureReport
from utils.logger import logger


class TestGetMeasureReport(unittest.TestCase):
    def setUp(self):
        cfg_info = NewConfig()
        ...
        self.report = GetMeasureReport(self.common, self.headers, self.access_token)
        logger.info(self.common.get('uname'))

    def tearDown(self):
        pass

    def test_get_measure_report(self):
        code, datas = self.report.get_measure_report(self.mID)
